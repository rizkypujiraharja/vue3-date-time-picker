...
import PresetRange from './PresetRange.vue';
...
const datesNextMonth = computed(() => {
    return getCalendarDays(monthNext.value, yearNext.value, +props.weekStart as WeekStartNum, props.hideOffsetDates);
});
